%A = imread("../Test Inputs/2015_00001.png");
%out = bpdhee(A);
%imwrite(out, "../Test Outputs/BPDHE/2015_00001.png")
filePattern = fullfile("../Test Inputs/", '*.png');
pngFiles = dir(filePattern);

filePattern = fullfile("../Test Inputs/", '*.jpg');
jpgFiles = dir(filePattern);

for k = 1:length(pngFiles)
  baseFileName = pngFiles(k).name;
  fullFileName = fullfile("../Test Inputs/", baseFileName);
  fprintf(1, 'Now reading %s\n', fullFileName);
  imageArray = imread(fullFileName);
  out = bpdhee(imageArray);
  imwrite(out, fullfile("../Test Outputs/BPDHE/", baseFileName));
end
